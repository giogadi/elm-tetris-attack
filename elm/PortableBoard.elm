...
stateToJson s = Array [boardToJson s.board, cursorToJson s.cursorIdx]

jsonToState : Value -> GameState
jsonToState (Array (boardJson :: cursorJson :: [])) =
  {board = jsonToBoard boardJson, cursorIdx = jsonToCursor cursorJson, dtOld = 0}
